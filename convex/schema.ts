...
export default defineSchema({
  ...
  contentTranslations: defineTable(
    v.union(
      v.object({
        familyId: v.id("families"),
        entityType: v.union(v.literal("task"), v.literal("routine"), v.literal("page"), v.literal("groceryItem"), v.literal("recipe"), v.literal("recipeIngredient"), v.literal("recipeStep")),
        entityId: v.union(v.id("tasks"), v.id("routines"), v.id("pages"), v.id("groceryItems"), v.id("recipes"), v.id("recipeIngredients"), v.id("recipeSteps")),
        field: v.union(v.literal("title"), v.literal("note"), v.literal("description"), v.literal("content"), v.literal("location"), v.literal("name"), v.literal("notes"), v.literal("text")),
